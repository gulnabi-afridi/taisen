      ...
      <Box sx={{
        ...
        <Container maxWidth="big"
          ...
          <Topography variant='h2' sx={{
            fontFamily: 'Cinzel',
            fontSize: {md: '80px', xs: '46px'},
            lineHeight: {md: '107.84px'},
            fontWeight: 700,
            color: '#FBFAF5',
          ...
          <Topography variant='h2' sx={{
            ...
            Lorem ipsum dolor sit amet, consectetur adipisci elit. Vestibulum varius, metus eu pretium auctor, dui
            arcure dui, at euismod orci quam et est. Ut quis mi ruum, venenatis ipsum in, semper magna. is eu quam
            ultricies, elementum etus nec, sollicitudin sem. Integer lectus diam, tempor ac finibus vel, tempor sit amet
            ipsum.metus eu pretium auctor, dui arcu ornare dui, t euismod orci quam et
          </Topography>
          <Box sx={!One && !Two && !Three && !Four && !Five && !Six && !Seven && !Eight ? {
            flexGrow: 1,
            width: '100%',
            mt: 18
          } : {display: 'none'}}>
            <Grid container columnSpacing={{md: 8, xs: 8}} rowSpacing={8}>
              {
                RoadmapFlow.map((item, index) => {
                  return <Grid key={index} item xs={12} sm={6} lg={4} >
                    <Box
                      onClick={item.ClickBtn}
                      onMouseOver={() => item.StateChange(true)}
                      onMouseLeave={() => item.StateChange(false)} sx={{
                      maxWidth: {md: '482px', xs: '350px'},
                      width: '100%',
                      ...
                      border: '6px dashed #FBD005',
                      // borderRadius: '50%',
                      p: 1,
                      transition: 'all 0.3s ease',
                      cursor: 'pointer',
                      "&:hover": {
                        background: '#FBD005', border: '6px solid #16021F'
                      },
                      "&:hover div": {
                        border: '5px solid #16021F'
                      },
                      "&:hover h2": {
                        color: '#16021F'
                      }
                      ...
                      <Box sx={{
                        ...
                        <Topography variant='h2' sx={{
                          fontFamily: 'Cinzel',
                          fontSize: {md: '100px', xs: '60px'},
                          lineHeight: {md: '134.8px'},
                          fontWeight: 700,
                          color: '#FBFAF5',
                          textTransform: 'uppercase',
                          transition: 'all 0.3s ease',
          ...
          <Box onClick={() => Back()} sx={One || Two || Three || Four || Five || Six || Seven || Eight ? {
            mt: {
              md: 24,
              xs: 10,
              width: '100%',
            ...
            <Box sx={{
              ...
              cursor: 'pointer',
              transition: 'all 0.3s ease',
              "&:hover": {border: 'none', background: 'linear-gradient(104.04deg, #FBD005 10.83%, #F58320 97.8%)'},
              "&:hover svg": {color: 'rgba(22, 2, 31, 1)'}
            }}>
